...
1. [Clear Instruction Design](#1-clear-instruction-design)  
2. [Role Prompting (Act As Strategy)](#2-role-prompting-act-as-strategy)  
3. [Context Injection](#3-context-injection)  
4. [Output Formatting Control](#4-output-formatting-control)  
...
8. [ReAct (Reason + Act) Prompting](#8-react-reason--act-prompting)  
9. [Prompt Chaining](#9-prompt-chaining)  
10. [Iterative Refinement](#10-iterative-refinement)  
11. [History Management](#11-history-management)  
12. [System Prompt Design](#12-system-prompt-design)  
13. [Constraint-Based Prompting](#13-constraint-based-prompting)  
14. [Delimiter & Structure Usage](#14-delimiter--structure-usage)  
15. [Temperature & Parameter Tuning](#15-temperature--parameter-tuning)  
16. [Guardrails & Safety Prompting](#16-guardrails--safety-prompting)  
17. [Anti-Hallucination Techniques](#17-anti-hallucination-techniques)  
18. [Self-Critique & Reflection Prompting](#18-self-critique--reflection-prompting)  
19. [Retrieval-Augmented Prompting (RAG Context Injection)](#19-retrieval-augmented-prompting-rag-context-injection)  
20. [Tree of Thoughts (ToT) Prompting](#20-tree-of-thoughts-tot-prompting)
